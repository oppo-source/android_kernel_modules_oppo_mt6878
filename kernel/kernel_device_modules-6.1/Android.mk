...
ifneq ($(OPLUS_KERNEL_MODULE_COVERAGE),)
  GCOV_KBUILD_ARG := --kocov
  $(info >>> GCOV_KBUILD_ARG: $(GCOV_KBUILD_ARG))
endif
...
ifeq ($(KERNEL_SANITIZER),kasan)
$(KERNEL_ZIMAGE_OUT): PRIVATE_BAZEL_BUILD_FLAG += --kasan --lto=none
else ifeq ($(KERNEL_SANITIZER),kcsan)
$(KERNEL_ZIMAGE_OUT): PRIVATE_BAZEL_BUILD_FLAG += --kcsan --lto=none
endif

ifneq ($(OPLUS_KERNEL_STABILITY_DEBUG),)
$(KERNEL_ZIMAGE_OUT): PRIVATE_BAZEL_BUILD_FLAG += --notrim --nokmi_symbol_list_strict_mode --nokmi_symbol_list_violations_check
$(KERNEL_ZIMAGE_OUT): PRIVATE_BAZEL_BUILD_FLAG += --defconfig_fragment=//kernel_device_modules-6.1:arch/arm64/configs/oplus_debug_defconfig
endif
