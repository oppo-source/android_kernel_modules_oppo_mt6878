...
//panel is dunhuang
	if(panel_is_dunhuang()) {
		msWrite4Byte(mtk_dp, 0x1138, 0x211a1612);
		msWrite4Byte(mtk_dp, 0x113c, 0x24241e18);
		msWrite4Byte(mtk_dp, 0x1140, 0x3029);
		msWrite4Byte(mtk_dp, 0x1144, 0x0f080400);
		msWrite4Byte(mtk_dp, 0x1148, 0x020c0600);
		msWrite4Byte(mtk_dp, 0x114c, 0x7);

		msWrite4Byte(mtk_dp, 0x1238, 0x21191512);
		msWrite4Byte(mtk_dp, 0x123c, 0x22241e18);
		msWrite4Byte(mtk_dp, 0x1240, 0x3028);
		msWrite4Byte(mtk_dp, 0x1244, 0x0f090500);
		msWrite4Byte(mtk_dp, 0x1248, 0x00c0600);
		msWrite4Byte(mtk_dp, 0x124c, 0x8);

		msWrite4Byte(mtk_dp, 0x1338, 0x221d1912);
		msWrite4Byte(mtk_dp, 0x133c, 0x24241e18);
		msWrite4Byte(mtk_dp, 0x1340, 0x3029);
		msWrite4Byte(mtk_dp, 0x1344, 0x0e090500);
		msWrite4Byte(mtk_dp, 0x1348, 0x020c0600);
		msWrite4Byte(mtk_dp, 0x134c, 0x7);

		msWrite4Byte(mtk_dp, 0x1438, 0x221d1912);
		msWrite4Byte(mtk_dp, 0x143c, 0x24241e18);
		msWrite4Byte(mtk_dp, 0x1440, 0x3029);
		msWrite4Byte(mtk_dp, 0x1444, 0x0e090500);
		msWrite4Byte(mtk_dp, 0x1448, 0x020c0600);
		msWrite4Byte(mtk_dp, 0x144c, 0x7);
	}
}
