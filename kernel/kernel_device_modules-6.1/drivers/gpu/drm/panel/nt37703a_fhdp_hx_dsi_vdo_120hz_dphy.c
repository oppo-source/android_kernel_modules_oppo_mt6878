...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx,0x3B,0x00,0x14,0x00,0x34,0x00,0x14,0x00,0x48,0x00,0x14,0x00,0x34,0x00,0x14,0x03,0x6A);
		...
		dcs_write_gce cb, void *handle, bool en)
{
	...
	if (en == 1) {
		if(oplus_display_brightness < 3516) {
			lcm_finger_lhbm_on_setting[2].para_list[7] = alpha_H[oplus_display_brightness];
			lcm_finger_lhbm_on_setting[2].para_list[8] = alpha_L[oplus_display_brightness];
		} else {
			lcm_finger_lhbm_on_setting[2].para_list[7] = alpha_H[3515];
			lcm_finger_lhbm_on_setting[2].para_list[8] = alpha_L[3515];
		}
		...
		lcm_lhbm_off_setbrightness_normal[3].para_list[1] = oplus_display_brightness >> 8;
		lcm_lhbm_off_setbrightness_normal[3].para_list[2] = oplus_display_brightness & 0xFF;
