...
GetBrightnessFuncPtr aw21024_get_breath_brightness_algo_func(BREATH_ALGO_ID algo_id)
{
...
EXPORT_SYMBOL(aw21024_get_breath_brightness_algo_func);
MODULE_DESCRIPTION("AW21024 LED breath algorithm");
