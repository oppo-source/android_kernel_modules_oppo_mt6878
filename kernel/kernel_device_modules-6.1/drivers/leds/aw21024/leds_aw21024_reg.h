...
#define AW21036_DEVICE_ADDR			(0x34 << 1) /* AD0棗>GND, addr = 0x38 */
...
static const int aw21024_reg_map[] = {
	0x4a, 0x01,
	0x4b, 0x02,
	0x4c, 0x03,
...
static  AW_MULTI_BREATH_DATA_STRUCT incall_effect_data1[] = {
	//effect2:moving
	{1, {20, 10, 40, 10,0, 20}, 1, 1, &rgb_incall_list[0], br_incall_fadeh, br_fadel},
	{1, {30, 10, 40, 10,0, 10}, 1, 1, &rgb_incall_list[1], br_incall_fadeh, br_fadel},
	{1, {10, 10, 40, 10,0, 30}, 1, 1, &rgb_incall_list[2], br_incall_fadeh, br_fadel},
	{1, {0, 10, 40, 10,0, 40}, 1, 1, &rgb_incall_list[3], br_incall_fadeh, br_fadel},
	{1, {30, 10, 40, 10,0,10}, 1, 1, &rgb_incall_list[4], br_incall_fadeh, br_fadel},
	{1, {20, 10, 40, 10,0, 20}, 1, 1, &rgb_incall_list[5], br_incall_fadeh, br_fadel},
	{1, {0, 10, 40, 10,0, 40}, 1, 1, &rgb_incall_list[6], br_incall_fadeh, br_fadel},
	{1, {10, 10, 40, 10,0, 30}, 1, 1, &rgb_incall_list[7], br_incall_fadeh, br_fadel},

	//effect2:moving
	{1, {10, 10, 40, 10,0, 30}, 1, 1, &rgb_incall_list[0], br_incall_fadeh, br_fadel},
	{1, {0, 10, 40, 10,0, 40}, 1, 1, &rgb_incall_list[1], br_incall_fadeh, br_fadel},
	{1, {20, 10, 40, 10,0, 20}, 1, 1, &rgb_incall_list[2], br_incall_fadeh, br_fadel},
	{1, {30, 10, 40, 10,0,10}, 1, 1, &rgb_incall_list[3], br_incall_fadeh, br_fadel},
	{1, {0, 10, 40, 10,0, 40}, 1, 1, &rgb_incall_list[4], br_incall_fadeh, br_fadel},
	{1, {10, 10, 40, 10,0, 30}, 1, 1, &rgb_incall_list[5], br_incall_fadeh, br_fadel},
	{1, {30, 10, 40, 10,0, 10}, 1, 1, &rgb_incall_list[6], br_incall_fadeh, br_fadel},
	{1, {20, 10, 40, 10,0, 20}, 1, 1, &rgb_incall_list[7], br_incall_fadeh, br_fadel},
};

static  AW_MULTI_BREATH_DATA_STRUCT poweron_effect_data1[] = {
	{20, {720,80,160,80,360,120}, 2, 1, &rgb_poweron_list[0], br_poweron_fadeh, br_fadel},
	{20, {0,80,160,80,360,840}, 2, 1, &rgb_poweron_list[1], br_poweron_fadeh, br_fadel},
	{20, {240,80,160,80,360,600}, 2, 1, &rgb_poweron_list[2], br_poweron_fadeh, br_fadel},
	{20, {480,80,160,80,360,360}, 2, 1, &rgb_poweron_list[3], br_poweron_fadeh, br_fadel},
	{20, {840,80,160,80,360,0}, 2, 1, &rgb_poweron_list[4], br_poweron_fadeh, br_fadel},
	{20, {120,80,160,80,360,720}, 2, 1, &rgb_poweron_list[5], br_poweron_fadeh, br_fadel},
	{20, {360,80,160,80,360,480}, 2, 1, &rgb_poweron_list[6], br_poweron_fadeh, br_fadel},
	{20, {600,80,160,80,360,240}, 2, 1, &rgb_poweron_list[7], br_poweron_fadeh, br_fadel},
};

static  AW_MULTI_BREATH_DATA_STRUCT notify_effect_data1[] = {
	{1, {0, 23, 45, 23, 23, 0}, 1, 1, &rgb_notify_list[0], br_notify_fadeh, br_fadel},
	{1, {0, 23, 45, 23, 23, 0}, 1, 1, &rgb_notify_list[1], br_notify_fadeh, br_fadel},
	{1, {0, 23, 45, 23, 23, 0}, 1, 1, &rgb_notify_list[2], br_notify_fadeh, br_fadel},
	{1, {0, 23, 45, 23, 23, 0}, 1, 1, &rgb_notify_list[3], br_notify_fadeh, br_fadel},
	{1, {0, 23, 45, 23, 23, 0}, 1, 1, &rgb_notify_list[4], br_notify_fadeh, br_fadel},
	{1, {0, 23, 45, 23, 23, 0}, 1, 1, &rgb_notify_list[5], br_notify_fadeh, br_fadel},
	{1, {0, 23, 45, 23, 23, 0}, 1, 1, &rgb_notify_list[6], br_notify_fadeh, br_fadel},
	{1, {0, 23, 45, 23, 23, 0}, 1, 1, &rgb_notify_list[7], br_notify_fadeh, br_fadel},
};
