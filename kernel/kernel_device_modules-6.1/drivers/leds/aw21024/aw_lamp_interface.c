...
void aw21024_set_colorful_rgb_data(uint8_t rgb_idx, uint8_t *dim_reg,
				AW_COLORFUL_INTERFACE_STRUCT *p_colorful_interface)
{
...
EXPORT_SYMBOL(aw21024_set_colorful_rgb_data);
#if 0
...
void aw21024_set_rgb_brightness(unsigned char rgb_idx,
...
EXPORT_SYMBOL(aw21024_set_rgb_brightness);
MODULE_DESCRIPTION("AW21024 LED lamp interface");
