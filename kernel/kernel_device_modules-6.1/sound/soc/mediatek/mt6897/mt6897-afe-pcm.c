					  ...
					  struct snd_ctl_elem_value *ucontrol)
{
	...
	int irq_id = -1;
	if (!afe->oplus_bargein_use_cm1) {
		memif_num = MT6897_BARGE_IN_MEMIF;
	} else {
		memif_num = MT6897_BARGE_IN_MEMIF_CM1;
	}
...
#ifdef OPLUS_ARCH_EXTENDS
	// Add for 4ch AEC
	SOC_DAPM_SINGLE_AUTODISABLE("DL_24CH_CH1", AFE_CONN040_1,
				    I_DL_24CH_CH1, 1, 0),
#endif
};
...
#ifdef OPLUS_ARCH_EXTENDS
	// Add for 4ch AEC
	SOC_DAPM_SINGLE_AUTODISABLE("DL_24CH_CH2", AFE_CONN041_1,
				    I_DL_24CH_CH2, 1, 0),
#endif
...
#ifdef OPLUS_ARCH_EXTENDS
	// Add for 4ch AEC
	SOC_DAPM_SINGLE_AUTODISABLE("DL_24CH_CH1", AFE_CONN042_1,
				    I_DL_24CH_CH1, 1, 0),
#endif
};
...
#ifdef OPLUS_ARCH_EXTENDS
	// Add for 4ch AEC
	SOC_DAPM_SINGLE_AUTODISABLE("DL_24CH_CH2", AFE_CONN043_1,
				    I_DL_24CH_CH2, 1, 0),
#endif
};
...
#ifdef OPLUS_ARCH_EXTENDS
static const struct snd_soc_dapm_widget mt6897_memif_widgets_channel_merge_in_adsp[] = {
	/* inter-connections */
	SND_SOC_DAPM_MIXER("UL0_CH1", SND_SOC_NOPM, 0, 0,
			   memif_ul0_ch1_mix, ARRAY_SIZE(memif_ul0_ch1_mix)),
	SND_SOC_DAPM_MIXER("UL0_CH2", SND_SOC_NOPM, 0, 0,
...
static const struct snd_soc_dapm_route mt6897_memif_routes[] = {
...
#ifdef OPLUS_ARCH_EXTENDS
	// Add for 4ch AEC
	{"UL_CM0_CH1", "DL_24CH_CH1", "Hostless_UL1 UL"},
	{"UL_CM0_CH2", "DL_24CH_CH2", "Hostless_UL1 UL"},
	{"UL_CM0_CH3", "DL_24CH_CH1", "Hostless_UL1 UL"},
	{"UL_CM0_CH4", "DL_24CH_CH2", "Hostless_UL1 UL"},
#endif
	...
	{"UL_CM0_CH1", "I2SIN4_CH2", "I2SIN4"},
	{"UL_CM0_CH1", "I2SIN4_CH3", "I2SIN4"},
	{"UL_CM0_CH1", "I2SIN4_CH4", "I2SIN4"},
	{"UL_CM0_CH2", "I2SIN4_CH1", "I2SIN4"},
	{"UL_CM0_CH2", "I2SIN4_CH2", "I2SIN4"},
	{"UL_CM0_CH2", "I2SIN4_CH3", "I2SIN4"},
	{"UL_CM0_CH2", "I2SIN4_CH4", "I2SIN4"},
	{"UL_CM0_CH3", "I2SIN4_CH1", "I2SIN4"},
	{"UL_CM0_CH3", "I2SIN4_CH2", "I2SIN4"},
	{"UL_CM0_CH3", "I2SIN4_CH3", "I2SIN4"},
	{"UL_CM0_CH3", "I2SIN4_CH4", "I2SIN4"},
	{"UL_CM0_CH4", "I2SIN4_CH1", "I2SIN4"},
	{"UL_CM0_CH4", "I2SIN4_CH2", "I2SIN4"},
	{"UL_CM0_CH4", "I2SIN4_CH3", "I2SIN4"},
...
#ifdef OPLUS_ARCH_EXTENDS
/* 2024/10/23, bargein (CM1) use irq0 conflicts with DL0, change DL0's irq0 to irq16 */
static const int memif_irq_usage_cm1[MT6897_MEMIF_NUM] = {
	/* TODO: verify each memif & irq */
	[MT6897_MEMIF_DL0] = MT6897_IRQ_16,
	[MT6897_MEMIF_DL1] = MT6897_IRQ_1,
	[MT6897_MEMIF_DL2] = MT6897_IRQ_2,
	[MT6897_MEMIF_DL3] = MT6897_IRQ_3,
	[MT6897_MEMIF_DL4] = MT6897_IRQ_4,
...
#ifdef OPLUS_ARCH_EXTENDS
	case AFE_VUL_CM1_BASE_MSB:
	case AFE_VUL_CM1_BASE:
	case AFE_VUL_CM1_END_MSB:
	case AFE_VUL_CM1_END:
...
static int mt6897_dai_memif_register(struct mtk_base_afe *afe)
{
	...
	if (afe->oplus_bargein_use_cm1) {
		...
		dai->dapm_widgets = mt6897_memif_widgets_channel_merge_in_adsp;
		dai->num_dapm_widgets = ARRAY_SIZE(mt6897_memif_widgets_channel_merge_in_adsp);
	}
	#endif
...
/* 2024/10/23, bargein (CM1) use irq0 conflicts with DL0, change DL0's irq0 to irq16 */
	ret = of_property_read_u32(pdev->dev.of_node,
			"bargein-use-cm1", &afe->oplus_bargein_use_cm1);
	if (ret) {
		afe->oplus_bargein_use_cm1 = 0;
	}
	pr_info("%s: bargein-use-cm1 %d\n", __func__, afe->oplus_bargein_use_cm1);
#endif
...
/* 2024/10/23, bargein (CM1) use irq0 conflicts with DL0, change DL0's irq0 to irq16 */
		...
		if (!afe->oplus_bargein_use_cm1) {
			...
			afe->memif[i].irq_usage = memif_irq_usage_cm1[i];
		}
#endif
