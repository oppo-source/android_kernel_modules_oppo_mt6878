...
static const char *const mt6897_sgen_spktest_str[] = {
	"Off", "On"
};
...
static int mt6897_sgen_spktest_get(struct snd_kcontrol *kcontrol,
			   struct snd_ctl_elem_value *ucontrol)
{
	return 0;
}
...
static int mt6897_sgen_spktest_set(struct snd_kcontrol *kcontrol,
			   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
	...
	if (mode > 0) {
		regmap_write(afe->regmap, AFE_SINEGEN_CON0, 0x04504504);
...
static const struct soc_enum mt6897_afe_sgen_enum[] = {
	...
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6897_sgen_spktest_str),
				mt6897_sgen_spktest_str),
};
...
static const struct snd_kcontrol_new mt6897_afe_sgen_controls[] = {
	...
	SOC_ENUM_EXT("Audio_SineGen_spktest", mt6897_afe_sgen_enum[7],
		     mt6897_sgen_spktest_get, mt6897_sgen_spktest_set),
};
