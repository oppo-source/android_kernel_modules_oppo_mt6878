...
TRACE_EVENT(oplus_fence_timeout,

	TP_PROTO(int pid, const char *name, int value),
	...
	TP_printk("pid=%d, timeout_type=%s, timeout=%d", __entry->pid, __get_str(name), __entry->value)
);
