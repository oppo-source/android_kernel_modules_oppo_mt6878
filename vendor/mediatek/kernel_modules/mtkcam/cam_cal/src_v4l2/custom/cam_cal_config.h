...
#define OTP_INDEX_NUM (9)
#define OTP_TBL_NUM   (130)
struct ois_cal_data {
	unsigned char ois_table[OTP_SIZE];
	unsigned char valid;
};
#endif /*OPLUS_FEATURE_CAMERA_COMMON*/
...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
	unsigned int (*parsing_ois_cal_data_from_preload)(unsigned char *eeprom_preload,
