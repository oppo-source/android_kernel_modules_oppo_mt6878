...
int connsys_a_die_efuse_read_adie6637_check_efuse_valid_mt6878_gen(
		...
		int *poffset)
{
	...
	if (consys_get_adie_chipid_mt6878() == ADIE_6637) {
		...
		connsys_a_die_efuse_read_adie6637_check_efuse_valid_mt6878_gen(0x0, &efuse_valid);
		...
		connsys_a_die_efuse_read_adie6637_check_efuse_valid_mt6878_gen(0x1D0, &efuse_valid);
		connsys_a_die_efuse_read_adie6637_get_efuse2_info_mt6878_gen(efuse_valid, &(chip_info_list[1]));
		connsys_a_die_efuse_read_adie6637_get_efuse3_info_mt6878_gen(efuse_valid, &(chip_info_list[2]));
	} else if (consys_get_adie_chipid_mt6878() == ADIE_6631 ||
		(consys_get_adie_chipid_mt6878() == ADIE_6686 &&
		bt_or_wifi_or_fm_on == true)) {
