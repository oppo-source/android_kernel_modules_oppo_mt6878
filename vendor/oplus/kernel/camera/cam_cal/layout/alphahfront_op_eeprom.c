...
#define PFX "CAM_CAL_ALPHAHFRONT"
...
static unsigned int do_single_lsc_alphahfront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_alphahfront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_alphahfront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x01C40055, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000530, 0x0000074C, do_single_lsc_alphahfront},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_alphahfront},  //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_alphahfront}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT alphahfront_op_eeprom = {
	.name = "alphahfront_op_eeprom",
