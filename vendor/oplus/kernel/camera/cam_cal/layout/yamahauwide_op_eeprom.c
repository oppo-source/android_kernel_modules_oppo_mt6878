...
#define PFX "CAM_CAL_YAMAHAUWIDE"
...
static unsigned int do_2a_gain_yamahauwide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x0065009A, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000530, 0x0000074C, do_single_lsc_yamahauwide},
		{0x00000001, 0x00000020, 0x00000010, do_2a_gain_yamahauwide},  //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_yamahauwide}
	}
};
