...
#define PFX "CAM_CAL_MILKYWAYC2WIDE"
...
static unsigned int do_single_lsc_milkywayc2wide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_milkywayc2wide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_milkywayc2wide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x0174009C, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x00000000, do_module_version},
		{0x00000001, 0x00000000, 0x00000002, do_part_number},
		{0x00000001, 0x00000B00, 0x0000074C, do_single_lsc_milkywayc2wide},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_milkywayc2wide},  //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_milkywayc2wide}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT milkywayc2wide_op_eeprom = {
	.name = "milkywayc2wide_op_eeprom",
