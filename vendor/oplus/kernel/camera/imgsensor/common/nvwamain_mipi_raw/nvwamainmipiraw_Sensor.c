...
static struct subdrv_mode_struct mode_struct[] = {
	{/* Reg_B4-S4_QBIN(VBIN)_4096x3072_30fps*/
	...
	{/*Reg-L1-S4 QBIN(VBIN) 4096x3072_2-exp LBMF 30FPS with PDAF VB_ma*/
	...
	{/* Reg-F8-S4 QRMSC_4096x3072_30FPS for insensor zoom--bayer*/
	...
	{/*Reg_L2-S4 Izoom 2exp-LBMF 4096x3072 @30FPS w/ PDAF VB_max*/
	...
	{/* Reg_F9-S4 8192x6144_30FPS full-raw*/
		.frame_desc = frame_desc_cus17,
		.num_entries = ARRAY_SIZE(frame_desc_cus17),
		.mode_setting_table = nvwamain_custom17_setting,
		.mode_setting_len = ARRAY_SIZE(nvwamain_custom17_setting),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = nvwamain_seamless_custom17,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(nvwamain_seamless_custom17),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 2196000000,
