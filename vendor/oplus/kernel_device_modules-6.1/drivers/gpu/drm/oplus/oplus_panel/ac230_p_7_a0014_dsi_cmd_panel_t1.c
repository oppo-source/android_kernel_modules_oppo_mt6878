...
#include "ac230_p_7_a0014_dsi_cmd_panel_t1.h"
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	DISP_ERR("ac230_p_7_a0014_t1 %s +, mode id=%d\n", __func__, mode_id);
	//panel_power_on = true;
	switch (mode_id) {
	case FHD_SDC60:
...
static int panel_lhbm_pressed_icon_grayscale_update(void *para_list, unsigned int bl_level)
{
	...
	if ((bl_level > 0x0000) && (bl_level <= 0x0481)) {
		memcpy(tx_buf, tx_buf_0, 5);
		need_to_update_grayscale = true;
	} else if ((bl_level > 0x0481) && (bl_level <= 0x0852)) {
		tx_buf[1] = (((bl_level-1154) * 2048 + 488) / 976) >> 8;
		tx_buf[2] = (((bl_level-1154) * 2048 + 488) / 976) & 0xFF;
		tx_buf[3] = 4095 >> 8;
		tx_buf[4] = 4095 & 0xFF;
		need_to_update_grayscale = true;
	} else if ((bl_level > 0x0852) && (bl_level < 0x0DBB)) {
		tx_buf[1] = (((bl_level-2130) * 225 + 693 ) / 1385 + 2048 ) >> 8;
		tx_buf[2] = (((bl_level-2130) * 225 + 693 ) / 1385 + 2048 ) & 0xFF;
		tx_buf[3] = 4095 >> 8;
		tx_buf[4] = 4095 & 0xFF;
		need_to_update_grayscale = true;
	} else if ((bl_level >= 0x0DBB) && (bl_level <= 0x0FFF)) {
		tx_buf[1] = (((bl_level-3515) * (2048 - 2273) + 290) / 580 + 2273) >> 8;
		tx_buf[2] = (((bl_level-3515) * (2048 - 2273) + 290) / 580 + 2273) & 0xFF;
		tx_buf[3] = 4095 >> 8;
		tx_buf[4] = 4095 & 0xFF;
		need_to_update_grayscale = true;
	}
...
static int lcm_panel_poweron(struct drm_panel *panel)
{
	...
	DISP_ERR("%s: ac230_p_7_a0014_t1 poweron Start\n", __func__);
	//iovcc enable 1.8V
	...
	DISP_ERR("%s: ac230_p_7_a0014_t1 poweron Successful\n", __func__);
	return 0;
}
...
static int lcm_panel_poweroff(struct drm_panel *panel)
{
	...
	DISP_ERR("%s: ac230_p_7_a0014_t1 poweroff Start\n", __func__);
	...
	if (ret < 0)
		lcm_unprepare(panel);
	DISP_ERR("%s: ac230_p_7_a0014_t1 poweroff Successful\n", __func__);
	return 0;
}
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	...
	pr_err("[LCM] %s+ ac230_p_7_a0014_t1 Start\n", __func__);
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	...
	pr_err("ac230_p_7_a0014_dsi_cmd_t1 lcm probe End.\n");
	return ret;
}
...
static const struct of_device_id lcm_of_match[] = {
	{
		.compatible = "ac230,p,7,a0014,cmd,t1",
	},
	{}
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "ac230_p_7_a0014_dsi_cmd_t1",
		.owner = THIS_MODULE,
...
MODULE_AUTHOR("oplus");
MODULE_DESCRIPTION("ac230,p,7,a0014,cmd,t1,OLED Driver");
