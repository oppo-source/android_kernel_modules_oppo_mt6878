...
#include "ac232_p_7_a0014_dsi_cmd_panel_t0.h"
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	DISP_ERR("ac232_p_7_a0014_dsi_cmd_t0 %s +, mode id=%d\n", __func__, mode_id);
	//panel_power_on = true;
	switch (mode_id) {
	case FHD_SDC60:
	...
	DISP_ERR("ac232_p_7_a0014_dsi_cmd_t0 %s -\n", __func__);
}
...
static int lcm_setbacklight_cmdq(void *dsi, dcs_write_gce cb, void *handle, unsigned int level)
{
	...
	DISP_ERR("ac232_p_7_a0014_dsi_cmd_t0 backlight = %d bl_level[1]=%x, bl_level[2]=%x\n", level, bl_level[1], bl_level[2]);
...
static int lcm_panel_poweron(struct drm_panel *panel)
{
	...
	DISP_ERR("%s: ac232_p_7_a0014_dsi_cmd_t0 poweron Successful\n", __func__);
	return 0;
}
...
static int lcm_panel_poweroff(struct drm_panel *panel)
{
	...
	if (ret < 0)
		lcm_unprepare(panel);
	DISP_ERR("%s: ac232_p_7_a0014_dsi_cmd_t0 poweroff Successful\n", __func__);
	return 0;
}
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	...
	pr_err("[LCM] %s+ ac232_p_7_a0014_dsi_cmd_t0 Start\n", __func__);
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	...
	pr_err("ac232_p_7_a0014_dsi_cmd_t0 lcm probe End.\n");
	return ret;
}
...
static const struct of_device_id lcm_of_match[] = {
	{
		.compatible = "ac232,p,7,a0014,cmd,t0",
	},
	{}
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "ac232_p_7_a0014_dsi_cmd_t0",
		.owner = THIS_MODULE,
...
MODULE_AUTHOR("oplus");
MODULE_DESCRIPTION("ac232,p,7,a0014,t0,OLED Driver");
