...
#include "panel_ae016_p_7_a0014_dsi_cmd.h"
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	DISP_ERR("panel_ae016_p_7_a0014_dsi_cmd %s +, mode id=%d\n", __func__, mode_id);
	//panel_power_on = true;
	switch (mode_id) {
	case FHD_SDC60:
	...
	DISP_ERR("%s,panel_ae016_p_7_a0014_dsi_cmd restore seed_mode:%d\n", __func__, temp_seed_mode);
	...
	DISP_ERR("panel_ae016_p_7_a0014_dsi_cmd %s -\n", __func__);
}
...
static int lcm_panel_poweron(struct drm_panel *panel)
{
	...
	DISP_ERR("%s: panel_ae016_p_7_a0014_dsi_cmd poweron Start\n", __func__);
	//iovcc enable 1.8V
	...
	DISP_ERR("%s: panel_ae016_p_7_a0014_dsi_cmd poweron Successful\n", __func__);
	return 0;
}
...
static int lcm_panel_poweroff(struct drm_panel *panel)
{
	...
	DISP_ERR("%s: panel_ae016_p_7_a0014_dsi_cmd poweroff Start\n", __func__);
	...
	if (ret < 0)
		lcm_unprepare(panel);
	DISP_ERR("%s: panel_ae016_p_7_a0014_dsi_cmd poweroff Successful\n", __func__);
	return 0;
}
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	...
	DISP_INFO("[LCM] %s+ panel_ae016_p_7_a0014 Start\n", __func__);
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel_ae016_p_7_a0014_dsi_cmd",
		.owner = THIS_MODULE,
...
MODULE_AUTHOR("oplus");
MODULE_DESCRIPTION("panel,ae016,p,7,a0014,OLED Driver");
